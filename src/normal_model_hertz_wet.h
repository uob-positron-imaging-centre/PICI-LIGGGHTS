...
#ifdef NORMAL_MODEL
NORMAL_MODEL(HERTZ_WET,hertz/wet,17)
#else
#ifndef NORMAL_MODEL_HERTZ_WET_H_
#define NORMAL_MODEL_HERTZ_WET_H_
...
{
  static ScalarProperty* createcRestitutionConstant(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
      return createScalarProperty(registry, "RestitutionConstant", caller);
  }
...
namespace ContactModels
{
  ...
  template<>
  class NormalModel<HERTZ_WET> : public NormalModelBase
  {
  public:
    ...
    void connectToProperties(PropertyRegistry & registry)
    {
      ...
      registry.registerProperty("Yeff", &MODEL_PARAMS::createYeff,"model hertz/wet");
      registry.registerProperty("Geff", &MODEL_PARAMS::createGeff,"model hertz/wet");
      registry.registerProperty("betaeff", &MODEL_PARAMS::createBetaEff,"model hertz/wet");
      registry.registerProperty("RestitutionConstant", &MODEL_PARAMS::createcRestitutionConstant,"model hertz/wet");

      registry.connect("Yeff", Yeff,"model hertz/wet");
      registry.connect("Geff", Geff,"model hertz/wet");
      registry.connect("betaeff", betaeff,"model hertz/wet");
      //registry.connect("RestitutionConstant", CoR_const,"model hertz/wet");
